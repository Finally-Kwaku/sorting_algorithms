 ...
 *
 * Return: oositive byte difference if a > b
 * 0 if a == b
...
/**
 * insertion_sort_deck_value - sorts a deck of cards sorted from spades to
 * diamonds from ace to king
 * @deck: pointer to the head of a deck_node_t doubly-linked list
 *
 */
...
/**
 * sort_deck - sorts a deck of cards from ace to king and from
 * spades to diamonds
 * @deck: pointer to the head of a deck_node_t doubly linked list
 *
 */
